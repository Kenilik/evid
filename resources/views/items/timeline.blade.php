				...
				@endif
					...
					<div class="timeline-panel" data-key="{{ $item->id }}">
						...
						<div class="timeline-body">
							...
							@endif
							<div class="textarea itemtags" contenteditable="false">
                                @foreach ($item->tags as $tag)
                                    <span class='itemtag' data-key='{{ $tag->id }}'>{{ $tag->name }}<a href="" class="remove" tabindex="-1" title="Remove"><i class="fa fa-times"></i></a></span>
                                @endforeach
                            </div>
						</div>
					</div>
